...
{
    public class FileCabinetStudentXmlWriter
    {
        private readonly XmlWriter writer;

        /// <summary>
        /// Initializes a new instance of the <see cref="FileCabinetStudentXmlWriter"/> class.
        /// </summary>
        /// <param name="xmlWriter">Text writer.</param>
        public FileCabinetStudentXmlWriter(XmlWriter xmlWriter)
        {
